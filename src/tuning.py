...
CANDIDATES = [0.0, 0.5, 1.0, 1.5, 2.5, 4.0]
...
def _predict_with_weights(data_slice, weights, min_value, max_value):
    scores = {
        value: 0.0
...
def backtest_accuracy(data, weights, min_value, max_value, warmup=WARMUP):
    ...
    setiap titik t, cuma pakai data[:t] buat nebak data[t] --
...
def tune_weights(data, min_value, max_value, base_weights=None):
    ...
    di histori, bukan tebakan manual.
    """
